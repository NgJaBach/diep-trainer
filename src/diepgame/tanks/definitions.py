...
class TankDef:
    ...
    body_shape: str = "circle"     # circle | smasher | spike
    notes: str = ""
...
_add("twin", name="Twin", tier=2,
     barrels=(Barrel(lat=-0.42, dmg=0.85, reload=1.0),
              Barrel(lat=0.42, delay=0.5, dmg=0.85)),
...
_add("sniper", name="Sniper", tier=2, fov=1.28,
     barrels=(Barrel(length=2.0, width=0.40, reload=1.9, spd=1.5,
                     dmg=1.15, pen=1.1, spread=0.4, recoil=1.4),),
     upgrades_to=("assassin", "overseer", "hunter", "trapper"))

_add("machine_gun", name="Machine Gun", tier=2,
     barrels=(Barrel(length=1.65, width=0.55, reload=0.55, dmg=0.72,
...
_add("twin_flank", name="Twin Flank", tier=3,
     barrels=(Barrel(lat=-0.42, dmg=0.8), Barrel(lat=0.42, delay=0.5, dmg=0.8),
              Barrel(angle=180, lat=-0.42, delay=0.5, dmg=0.8),
              Barrel(angle=180, lat=0.42, dmg=0.8)),
...
_add("assassin", name="Assassin", tier=3, fov=1.45,
     barrels=(Barrel(length=2.2, width=0.38, reload=2.3, spd=1.75,
                     dmg=1.35, pen=1.2, spread=0.25, recoil=1.7),),
...
_add("overseer", name="Overseer", tier=3, fov=1.12, max_drones=8,
     ...
     upgrades_to=("overlord", "manager", "battleship", "overtrapper"))
...
_add("gunner", name="Gunner", tier=3,
     barrels=(Barrel(lat=-0.62, length=1.45, width=0.22, delay=0.0, dmg=0.45,
                     pen=0.5, reload=0.85, size=1.0),
              Barrel(lat=0.62, length=1.45, width=0.22, delay=0.5, dmg=0.45,
                     pen=0.5, reload=0.85),
              Barrel(lat=-0.21, length=1.7, width=0.22, delay=0.25, dmg=0.45,
                     pen=0.5, reload=0.85),
              Barrel(lat=0.21, length=1.7, width=0.22, delay=0.75, dmg=0.45,
                     pen=0.5, reload=0.85)),
...
_add("sprayer", name="Sprayer", tier=4,
     barrels=(Barrel(length=1.9, width=0.34, reload=0.5, dmg=0.55, pen=0.6,
                     spread=3.0),
              Barrel(length=1.6, width=0.58, reload=0.5, delay=0.5, dmg=0.66,
                     pen=0.7, spread=12, trapezoid=True)))

_add("triplet", name="Triplet", tier=4,
     barrels=(Barrel(lat=-0.5, length=1.6, dmg=0.74),
              Barrel(lat=0.5, length=1.6, dmg=0.74),
              Barrel(length=1.78, delay=0.5, dmg=0.74)))
...
_add("ranger", name="Ranger", tier=4, fov=1.7,
     barrels=(Barrel(length=2.35, width=0.36, reload=2.5, spd=2.05, dmg=1.5,
                     pen=1.3, spread=0.15, recoil=2.0, trapezoid=False),))

_add("stalker", name="Stalker", tier=4, fov=1.45, invisible_when_idle=True,
     barrels=(Barrel(length=2.2, width=0.38, reload=2.3, spd=1.8, dmg=1.35,
...
_add("streamliner", name="Streamliner", tier=4, fov=1.18,
     barrels=tuple(Barrel(length=2.1 - i * 0.12, width=0.36, reload=0.42,
                          delay=i * 0.2, dmg=0.32, pen=0.4, spd=1.6,
                          spread=1.2)
                   for i in range(5)))
...
_add("gunner_trapper", name="Gunner Trapper", tier=4,
     barrels=(Barrel(lat=-0.3, length=1.6, width=0.24, dmg=0.5, pen=0.55,
                     reload=0.8),
              Barrel(lat=0.3, length=1.6, width=0.24, delay=0.5, dmg=0.5,
                     pen=0.55, reload=0.8),
